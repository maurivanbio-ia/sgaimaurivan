  ...
  async getDatasets(filters?: {
    ...
    const result = await db
      .select({
        ...
        // Campos de código padronizado e metadados
        codigoArquivo: datasets.codigoArquivo,
        cliente: datasets.cliente,
        uf: datasets.uf,
        projeto: datasets.projeto,
        subprojeto: datasets.subprojeto,
        disciplina: datasets.disciplina,
        tipoDocumento: datasets.tipoDocumento,
        entrega: datasets.entrega,
        area: datasets.area,
        periodo: datasets.periodo,
        dataReferencia: datasets.dataReferencia,
        responsavel: datasets.responsavel,
        versao: datasets.versao,
        status: datasets.status,
        classificacao: datasets.classificacao,
        titulo: datasets.titulo,
        pastaDestino: datasets.pastaDestino,
        hashSha256: datasets.hashSha256,
