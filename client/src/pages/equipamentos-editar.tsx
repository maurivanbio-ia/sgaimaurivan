  ...
  useEffect(() => {
    if (equipamento) {
      form.reset({
        ...
        status: (equipamento.status as "funcionando" | "com_defeito" | "em_manutencao" | "descartado") || "funcionando",
        localizacaoAtual: (equipamento.localizacaoAtual as "escritorio" | "cliente" | "colaborador") || "escritorio",
        localizacaoPadrao: (equipamento.localizacaoPadrao as "escritorio" | "cliente" | "colaborador") || "escritorio",
        ...
        frequenciaManutencao: (equipamento.frequenciaManutencao as "trimestral" | "semestral" | "anual") || "anual",
