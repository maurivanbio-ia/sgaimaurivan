...
// Non-admin roles can view and create but NOT edit/delete (admin-only)
const createOnly: ModuleAccess = { view: true, create: true, edit: false, approve: false, delete: false };
const createOnlyApprove: ModuleAccess = { view: true, create: true, edit: false, approve: true, delete: false };
...
export const PERMISSIONS: Record<UserRole, Record<ModuleName, ModuleAccess>> = {
  ...
  diretor: {
    dashboard: fullAccess,
    dashboard_executivo: fullAccess,
    dashboard_coordenador: createOnlyApprove,
    meu_painel: fullAccess,
    empreendimentos: createOnly,
    licencas: createOnly,
    condicionantes: createOnly,
    entregas: createOnly,
    ...
    frota: createOnly,
    equipamentos: createOnly,
    rh: createOnly,
    sst: createOnly,
    projetos: createOnly,
    contratos: createOnlyApprove,
    financeiro: createEditApprove,
    campanhas: createOnly,
